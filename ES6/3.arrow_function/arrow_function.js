...
// 매개변수가 여려개일 경우, 매개변수 위치의 소괄호를 제거할 수 없음
func2 = (arg1, arg2) => { }
// fucn2 = arg1, arg2 => { }       // 1. func2 = arg1; 2. arg2 = { }
...
// 구현부가 한줄이면서 객체 리터럴을 반환할 떄는 함수의 코드블럭을 제거하면 객체 리터럴을 소괄호로 묶어야 함
 fun2 = (name, tombName) => { return {name, tombName}};

func2 = (name, tombName) => ({name, tombName});

/*
    화살표 함수의 호출 : 
    - 화살표 함수는 익명 함수로만 선언되기 때문에 함수 표현식을 이용해서 변수에 담아 사용한다.
    - 콜백 함수에 많이 사용
*/
const pow = (x) => {
    return x * x;
