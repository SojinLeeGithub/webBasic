...
// 만약에 배열 디스트럭처링에 배열의 길이를 초과한 변수를 선언하면 초과한 범위에 해당하는 변수는 undefined가 지정된다.
...
// 객체 디스트럭쳐링 변수의 순서는 상관없지만, 이름은 반드시 객체 키의 이름과 같아야 함
// 키 이름과 다르게 사용하고 싶을 땐 키 : 변수명을 사용
// const {birth: birthday, name, tombName } = king;
// console.log(name, tombName, birth);
...
/*
    spread 연산자를 활용
    - 마지막 스프레드 연산자를 사용하면 나머지 모든 속성을 묶어서 새로운 객체 생성
*/
