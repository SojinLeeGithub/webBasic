...
/*
    숫자 타입으로 형변환
    - + 연산자를 제외한 나머지 산술 연산 혹은 대소 비교 연산에 대해서 좌항과 우항 중 하나라도 숫자가 존재하면 숫자가 아닌 항을 숫자로 자동 형변환 시킨다. 
*/
console.log( 1 - '1');  
...
console.log((10).toString(), typeof String());
...
/*
    불리언 타입으로 형변환
    - Boolean 클래스의 생성자 함수를 사용 (new연산자 없이 사용)
    - 
*/
// console.log(Boolean('문자열'), typeof) Boolean
