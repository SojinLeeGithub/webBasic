...
/*
    ...
    - 배열[인텍스]로 요소에 접근 가능, 존재하지 않는 인덱스에 접근하면 undefined 반환
...
/*
    includes(element) : 배열에 전달된 매개변수가 요소에 존재하면 true, 존재하지 않으면 false 반환
    - 
*/
...
/*
    ...
    - 배열의 요소를 제거하고 제거한 위치에 요소를 깔아끼운 배열을 반환
*/
